package com.dailybook.expense.screen.reports.fragment
...
import com.dailybook.expense.databinding.FragmentTransactionReportsBinding
import com.dailybook.expense.databinding.LayoutReportTemplateBinding
import com.dailybook.expense.model.Transaction
import com.dailybook.expense.screen.reports.adapter.TransactionReportsAdapter
...
class TransactionReportsFragment : BaseFragment<FragmentTransactionReportsBinding>() {
    ...
    private var transactionType: String = Constants.DEBIT
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            transactionType = it.getString(ARG_TRANSACTION_TYPE, Constants.DEBIT)
...
//            }
    ...
    private fun buildReportText(): String {
        ...
        return getString(com.dailybook.base.R.string.refer_friend_whatsapp_message)
    }
    ...
    private suspend fun createFormattedReportView(): View? {
        ...
        filteredTransactions.forEach { transaction ->
            ...
            val whiteColor = ContextCompat.getColor(requireContext(), com.boilerplate.uikit.R.color.white)
    ...
    private fun createTransactionItemView(transaction: Transaction): View {
        ...
        val cellHeight = resources.getDimensionPixelSize(com.boilerplate.uikit.R.dimen.margin_48)
        val cellPadding = resources.getDimensionPixelSize(com.boilerplate.uikit.R.dimen.margin_8)
    ...
    private fun openPlayStore() {
        try {
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.dailybook"))
            startActivity(intent)
        } catch (e: ActivityNotFoundException) {
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.dailybook"))
            startActivity(intent)
        }
    }
