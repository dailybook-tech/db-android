...
import com.laborbook.expense.R
import com.laborbook.expense.databinding.FragmentTransactionReportsBinding
import com.laborbook.expense.databinding.LayoutReportTemplateBinding
...
//            }
    ...
    private fun buildReportText(): String {
        ...
        return getString(com.laborbook.base.R.string.refer_friend_whatsapp_message)
    }
    ...
    private fun openPlayStore() {
        try {
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.laborbook"))
            startActivity(intent)
        } catch (e: ActivityNotFoundException) {
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.laborbook"))
            startActivity(intent)
        }
    }
