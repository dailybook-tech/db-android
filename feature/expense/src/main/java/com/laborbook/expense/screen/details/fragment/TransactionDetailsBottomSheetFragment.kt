...
class TransactionDetailsBottomSheetFragment : BaseBottomsheetFragment<FragmentTransactionDetailsBinding>() {
    ...
    private fun findExpenseFragment(): com.laborbook.expense.screen.home.fragment.ExpenseFragment? {
        ...
        return try {
            ...
            fun findFragmentRecursive(fragments: List<androidx.fragment.app.Fragment>): com.laborbook.expense.screen.home.fragment.ExpenseFragment? {
                for (fragment in fragments) {
                    if (fragment is com.laborbook.expense.screen.home.fragment.ExpenseFragment) {
                        return fragment
                    }
