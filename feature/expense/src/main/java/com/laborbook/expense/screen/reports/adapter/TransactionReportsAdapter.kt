...
class TransactionReportViewHolder(
    ...
    fun bind(transaction: Transaction) {
        ...
        val amountColor = if (transaction.type == Constants.DEBIT) {
            binding.root.context.getColor(com.laborbook.expense.R.color.error_state_color)
        } else {
            binding.root.context.getColor(com.laborbook.expense.R.color.button_green_color)
        }
