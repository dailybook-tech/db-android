package co.dailybook.expense.screen.home.fragment
...
import co.dailybook.expense.databinding.FragmentExpenseBinding
import co.dailybook.expense.model.Transaction
import co.dailybook.expense.model.TransactionItem
import co.dailybook.expense.model.TransactionsResponseModel
import co.dailybook.expense.screen.cashentry.fragment.CashInOutBottomSheetFragment
import co.dailybook.expense.screen.details.fragment.TransactionDetailsBottomSheetFragment
import co.dailybook.expense.screen.home.adapter.TransactionListAdapter
...
import co.dailybook.expense.screen.transactionstatus.fragment.TransactionStatusFragment
...
import co.dailybook.expense.screen.monthchooser.MonthYearChooserFragment
...
class ExpenseFragment : BaseFragment<FragmentExpenseBinding>() {
    ...
    private fun openReportsFragment() {
        ...
        fragmentNavigator.start(
            co.dailybook.expense.screen.reports.fragment.TransactionReportsFragment.newInstance(
