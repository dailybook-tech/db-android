package co.dailybook.expense.screen.details.fragment
...
import co.dailybook.expense.databinding.FragmentTransactionDetailsBinding
...
class TransactionDetailsBottomSheetFragment : BaseBottomsheetFragment<FragmentTransactionDetailsBinding>() {
    ...
    private fun findExpenseFragment(): co.dailybook.expense.screen.home.fragment.ExpenseFragment? {
        ...
        return try {
            ...
            fun findFragmentRecursive(fragments: List<androidx.fragment.app.Fragment>): co.dailybook.expense.screen.home.fragment.ExpenseFragment? {
                for (fragment in fragments) {
                    if (fragment is co.dailybook.expense.screen.home.fragment.ExpenseFragment) {
                        return fragment
                    }
