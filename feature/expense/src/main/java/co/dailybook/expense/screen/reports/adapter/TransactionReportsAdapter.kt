package co.dailybook.expense.screen.reports.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.DiffUtil
import androidx.recyclerview.widget.ListAdapter
import co.dailybook.expense.databinding.ItemTransactionReportBinding
...
class TransactionReportViewHolder(
    ...
    fun bind(transaction: Transaction) {
        ...
        val amountColor = if (transaction.type == Constants.DEBIT) {
            binding.root.context.getColor(co.dailybook.expense.R.color.error_state_color)
        } else {
            binding.root.context.getColor(co.dailybook.expense.R.color.button_green_color)
        }
