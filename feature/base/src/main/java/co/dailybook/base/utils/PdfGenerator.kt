package co.dailybook.base.utils
    ...
    companion object {
        ...
        fun generateStaffReport(
            ...
            try {
                ...
                try {
                    ...
                    footerTable.addCell(createFooterCell(englishContext.getString(R.string.report_generated_by_dailybook), true))
                    footerTable.addCell(createFooterCellWithLink(englishContext.getString(R.string.download_app_for_free_newline), "https://play.google.com/store/apps/details?id=co.dailybook", false))
        ...
        fun generatePayslip(
            ...
            try {
                ...
                footerTable.addCell(createFooterCellWithLink("Download on Play Store", "https://play.google.com/store/apps/details?id=co.dailybook", false))
                document.add(footerTable)
