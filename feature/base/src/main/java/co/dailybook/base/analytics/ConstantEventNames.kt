package co.dailybook.base.analytics
...
class ConstantEventNames {
    companion object {
        ...
        const val DELETE_STAFF_BS = "delete_staff_bs"
        ...
        const val STAFF_REPORTS_TAP = "staff_reports_tap"
        const val REFER_A_FRIEND = "refer_a_friend"
        const val SEARCH_STAFF = "search_staff"
        const val VIEW_STAFF_CALENDAR = "view_staff_calendar"

        const val PERMIT_CONTACTS = "permit_contacts"
        const val SHOW_MANUAL_ADD_STAFF_FORM = "show_manual_add_staff"
        const val ADD_STAFF_FROM_CONTACTS = "add_staff_from_contacts"
        const val ADD_STAFF_MANUAL = "add_staff_manual"
        ...
        const val SHARE_ATTENDANCE_TO_STAFF = "share_attendance_to_staff"
