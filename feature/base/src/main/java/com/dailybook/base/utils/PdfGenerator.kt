    ...
    companion object {
        ...
        fun generateStaffReport(
            ...
            try {
                ...
                try {
                    ...
                    footerTable.addCell(createFooterCellWithLink(englishContext.getString(R.string.download_app_for_free_newline), "https://play.google.com/store/apps/details?id=com.dailybook", false))
        ...
        fun generatePayslip(
            ...
            try {
                ...
                footerTable.addCell(createFooterCellWithLink("Download on Play Store", "https://play.google.com/store/apps/details?id=com.dailybook", false))
                document.add(footerTable)
