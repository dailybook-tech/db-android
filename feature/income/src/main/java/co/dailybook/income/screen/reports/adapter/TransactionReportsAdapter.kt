package co.dailybook.income.screen.reports.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.DiffUtil
import androidx.recyclerview.widget.ListAdapter
import co.dailybook.income.databinding.ItemTransactionReportBinding
...
class TransactionReportViewHolder(
    ...
    fun bind(transaction: Transaction) {
        ...
        val amountColor = if (transaction.type == Constants.DEBIT) {
            binding.root.context.getColor(co.dailybook.income.R.color.error_state_color)
        } else {
            binding.root.context.getColor(co.dailybook.income.R.color.button_green_color)
        }
