package com.dailybook.income.screen.details.fragment
...
import kotlinx.coroutines.launch
import com.dailybook.income.databinding.FragmentTransactionDetailsBinding
...
class TransactionDetailsBottomSheetFragment : BaseBottomsheetFragment<FragmentTransactionDetailsBinding>() {
    ...
    private fun findIncomeFragment(): com.dailybook.income.screen.home.fragment.IncomeFragment? {
        ...
        return try {
            ...
            fun findFragmentRecursive(fragments: List<androidx.fragment.app.Fragment>): com.dailybook.income.screen.home.fragment.IncomeFragment? {
                for (fragment in fragments) {
                    if (fragment is com.dailybook.income.screen.home.fragment.IncomeFragment) {
                        return fragment
                    }
