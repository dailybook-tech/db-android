...
class TransactionDetailsBottomSheetFragment : BaseBottomsheetFragment<FragmentTransactionDetailsBinding>() {
    ...
    private fun findIncomeFragment(): com.laborbook.income.screen.home.fragment.IncomeFragment? {
        ...
        return try {
            ...
            fun findFragmentRecursive(fragments: List<androidx.fragment.app.Fragment>): com.laborbook.income.screen.home.fragment.IncomeFragment? {
                for (fragment in fragments) {
                    if (fragment is com.laborbook.income.screen.home.fragment.IncomeFragment) {
                        return fragment
                    }
