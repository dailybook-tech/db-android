...
import co.dailybook.keep.databinding.FragmentCreateTeamBottomsheetBinding
...
class CreateTeamBottomSheetFragment : BaseBottomsheetFragment<FragmentCreateTeamBottomsheetBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        editingTeamId?.let { binding?.tvTitle?.setText(co.dailybook.keep.R.string.edit_profile) }
