...
import co.dailybook.base.hideKeyboard
import kotlinx.coroutines.flow.launchIn
import kotlinx.coroutines.flow.onEach
import co.dailybook.base.languagemanager.LanguageBottomSheetFragment
import com.google.firebase.ktx.Firebase
import com.google.firebase.remoteconfig.ktx.remoteConfig
import co.dailybook.keep.databinding.FragmentStaffListBinding
import co.dailybook.keep.screen.addstaff.fragment.AddStaffContactsFragment
import co.dailybook.keep.screen.calendar.utils.ObserverUtil
import co.dailybook.keep.screen.home.adapter.StaffUserAdapter
...
class StaffListFragment : BaseFragment<FragmentStaffListBinding>() {
        ...
        binding?.apply {
            ...
            ivProTag.setOnClickListener {
                lifecycleScope.launch {
                    ...
                    recordClickEvent(ConstantEventNames.VIEW_DAILYBOOK_PRO, hashMapOf(
    ...
    private fun updateTeamFilterChips() {
        ...
        // "All" chip
        addTeamChip(container, null, getString(co.dailybook.keep.R.string.all_workers), selectedTeamId == null)
    ...
    private fun addTeamChip(container: android.widget.LinearLayout, teamId: String?, label: String, isSelected: Boolean) {
        val chip = TextView(requireContext()).apply {
            ...
            textSize = 11f
            setPadding(
                resources.getDimensionPixelSize(co.dailybook.boilerplate.uikit.R.dimen.margin_10),
                resources.getDimensionPixelSize(co.dailybook.boilerplate.uikit.R.dimen.margin_4),
                resources.getDimensionPixelSize(co.dailybook.boilerplate.uikit.R.dimen.margin_10),
                resources.getDimensionPixelSize(co.dailybook.boilerplate.uikit.R.dimen.margin_4),
            )
            val lp = android.widget.LinearLayout.LayoutParams(
                ...
                android.widget.LinearLayout.LayoutParams.WRAP_CONTENT
            ).apply { marginEnd = resources.getDimensionPixelSize(co.dailybook.boilerplate.uikit.R.dimen.margin_6) }
            layoutParams = lp
            background = androidx.core.content.ContextCompat.getDrawable(
                requireContext(),
                if (isSelected) co.dailybook.keep.R.drawable.custom_radio_button_bg_selected
                else co.dailybook.keep.R.drawable.custom_radio_button_bg
            )
            setTextColor(androidx.core.content.ContextCompat.getColor(
                requireContext(),
                if (isSelected) android.R.color.white
                else co.dailybook.keep.R.color.custom_radio_text_color
            ))
            isClickable = true
            isFocusable = true
            setOnClickListener {
