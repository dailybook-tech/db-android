...
import co.dailybook.keep.databinding.FragmentOvertimeBottomsheetBinding
...
private fun NumberPicker.applyConsistentStyling(context: android.content.Context) {
    ...
    for (i in 0 until childCount) {
        ...
        if (child is EditText) {
            child.apply {
                ...
                setTextColor(ContextCompat.getColor(context, co.dailybook.boilerplate.uikit.R.color.text_20_color))
                isFocusable = false
    ...
    try {
        ...
        paint.color = ContextCompat.getColor(context, co.dailybook.boilerplate.uikit.R.color.text_20_color)
        ...
        try {
            ...
            selectorPaint.color = ContextCompat.getColor(context, co.dailybook.boilerplate.uikit.R.color.text_20_color)
...
class OvertimeBottomSheetFragment : BaseBottomsheetFragment<FragmentOvertimeBottomsheetBinding>(), KoinComponent {
    ...
    private fun showTimePicker() {
        ...
        val btnOk = view.findViewById<co.dailybook.boilerplate.uikit.views.buttons.PrimaryButton>(R.id.btn_picker_ok)
