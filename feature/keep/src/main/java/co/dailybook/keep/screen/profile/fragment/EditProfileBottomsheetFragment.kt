...
import co.dailybook.keep.databinding.FragmentEditProfileBottomsheetBinding
...
class EditProfileBottomsheetFragment : BaseBottomsheetFragment<FragmentEditProfileBottomsheetBinding>() {
    ...
    private val viewModel: co.dailybook.keep.screen.profile.viewmodel.EditProfileViewModel by viewModel()
