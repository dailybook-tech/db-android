...
import com.laborbook.keep.R as KeepR
import com.laborbook.keep.databinding.FragmentCashbookBinding
import com.laborbook.keep.screen.monthchooser.MonthYearChooserFragment
    ...
    private fun updateBalanceSummary() {
        ...
        binding?.tvBalance?.apply {
            ...
            val balanceColor = if (balance >= 0)
                androidx.core.content.ContextCompat.getColor(requireContext(), com.laborbook.keep.R.color.green)
            else
