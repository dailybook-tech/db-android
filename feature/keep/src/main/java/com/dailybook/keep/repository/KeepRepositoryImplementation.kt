...
import com.dailybook.keep.screen.addstaff.model.ContactDao
...
class KeepRepositoryImplementation(val keepNetworkModule: KeepNetworkModule, private val contactDao: ContactDao): KeepRepository {
    ...
    override suspend fun addOrUpdateSalary(userId: String, body: com.dailybook.keep.model.AddOrUpdateSalaryRequestBody): Flow<NetworkResult<String?>> =
