package com.dailybook.keep.screen.teams
...
import com.dailybook.keep.databinding.FragmentCreateTeamBottomsheetBinding
...
class CreateTeamBottomSheetFragment : BaseBottomsheetFragment<FragmentCreateTeamBottomsheetBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        editingTeamId?.let { binding?.tvTitle?.setText(com.dailybook.keep.R.string.edit_profile) }
