...
import com.dailybook.keep.databinding.FragmentStaffListBinding
import com.dailybook.keep.screen.addstaff.fragment.AddStaffContactsFragment
import com.dailybook.keep.screen.calendar.utils.ObserverUtil
import com.dailybook.keep.screen.home.adapter.StaffUserAdapter
...
class StaffListFragment : BaseFragment<FragmentStaffListBinding>() {
        ...
        adapter = StaffUserAdapter(
            ...
            onLockedStaffClick = {
                ...
                if (SubscriptionsFeatureFlag.isSubscriptionsEnabled(remoteConfig)) {
                    ...
                    val premiumDialog = com.dailybook.keep.screen.premium.PremiumOfferDialogFragment.newInstance()
                    premiumDialog.show(parentFragmentManager, com.dailybook.keep.screen.premium.PremiumOfferDialogFragment.TAG)
    ...
    private fun updateTeamFilterChips() {
        ...
        // "All" chip
        addTeamChip(container, null, getString(com.dailybook.keep.R.string.all_workers), selectedTeamId == null)
