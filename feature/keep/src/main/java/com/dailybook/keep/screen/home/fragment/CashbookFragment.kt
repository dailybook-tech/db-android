...
import com.dailybook.expense.screen.home.fragment.ExpenseFragment
import com.dailybook.income.screen.home.fragment.IncomeFragment
import com.dailybook.keep.R as KeepR
import com.dailybook.keep.databinding.FragmentCashbookBinding
import com.dailybook.keep.screen.monthchooser.MonthYearChooserFragment
    ...
    private fun updateBalanceSummary() {
        ...
        binding?.tvBalance?.apply {
            ...
            val balanceColor = if (balance >= 0)
                androidx.core.content.ContextCompat.getColor(requireContext(), com.dailybook.keep.R.color.green)
            else
                androidx.core.content.ContextCompat.getColor(requireContext(), com.boilerplate.uikit.R.color.button_red_color)
