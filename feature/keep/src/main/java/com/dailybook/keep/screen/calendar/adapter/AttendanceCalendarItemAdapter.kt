package com.dailybook.keep.screen.calendar.adapter
...
import com.boilerplate.uikit.views.invisible
...
import com.dailybook.keep.databinding.ItemCalendarAttendanceBinding
import com.dailybook.keep.model.AttendanceItem
import com.dailybook.keep.model.CalendarItem
import com.dailybook.keep.screen.advance.PayAdvanceBottomsheetFragment
import com.dailybook.keep.screen.advance.AdvanceDetailsBottomsheetFragment
import com.dailybook.keep.screen.attendance.AttendanceMarkBottomsheetFragment
        ...
        private fun setAdvance(calendarItem: CalendarItem) {
            ...
            when {
                hasAdvanceAmount -> {
                    ...
                    binding.tvAddAdvance.setTextColor(binding.tvAddAdvance.context.resources.getColor(com.boilerplate.uikit.R.color.absent))
                ...
                hasNotes -> {
                    ...
                    binding.tvAddAdvance.setTextColor(binding.tvAddAdvance.context.resources.getColor(com.boilerplate.uikit.R.color.hint_text_color))
