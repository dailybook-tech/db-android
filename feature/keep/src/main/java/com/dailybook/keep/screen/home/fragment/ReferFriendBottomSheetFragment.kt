...
import com.dailybook.keep.databinding.FragmentReferFriendBottomsheetBinding
import java.io.File
...
class ReferFriendBottomSheetFragment : BaseBottomsheetFragment<FragmentReferFriendBottomsheetBinding>() {
    ...
    private fun shareOnWhatsApp() {
        try {
            ...
            val inputStream = resources.openRawResource(com.dailybook.base.R.raw.share_image)
