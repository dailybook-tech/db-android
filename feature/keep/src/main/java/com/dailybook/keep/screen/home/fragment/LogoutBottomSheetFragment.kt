...
import com.dailybook.keep.databinding.FragmentLogoutBottomsheetBinding
...
class LogoutBottomSheetFragment : BaseBottomsheetFragment<FragmentLogoutBottomsheetBinding>() {
    ...
    private fun handleLogout() {
        lifecycleScope.launch {
            ...
            val intent = Intent(requireContext(), Class.forName("com.dailybook.auth.screen.login.view.LoginActivity")).apply {
