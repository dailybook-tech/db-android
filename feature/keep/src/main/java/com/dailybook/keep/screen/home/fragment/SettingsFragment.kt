package com.dailybook.keep.screen.home.fragment
...
import com.dailybook.base.languagemanager.LanguageBottomSheetFragment
import com.dailybook.base.navigator.FragmentNavigator
import com.google.firebase.ktx.Firebase
import com.google.firebase.remoteconfig.ktx.remoteConfig
import com.dailybook.keep.databinding.FragmentSettingsBinding
...
import com.dailybook.keep.screen.profile.fragment.UpdateNameBottomsheetFragment
import com.dailybook.keep.utils.SubscriptionsFeatureFlag
import com.dailybook.keep.screen.profile.uistate.UserUiState
...
class SettingsFragment : BaseFragment<FragmentSettingsBinding>() {
    ...
    private fun registerOnClickListeners() {
        ...
        binding?.clTerms?.setOnClickListener {
            ...
            openUrlInWebView(requireContext(), termsAndConditionsUrl, getString(com.dailybook.keep.R.string.terms_conditions))
        ...
        binding?.clPrivacyPolicy?.setOnClickListener {
            ...
            openUrlInWebView(requireContext(), privacyPolicyUrl, getString(com.dailybook.keep.R.string.privacy_policy))
        ...
        binding?.clManageTeams?.setOnClickListener {
            fragmentNavigator.start(com.dailybook.keep.screen.teams.TeamListFragment.newInstance())
        }
        ...
        binding?.clDailybookPro?.setOnClickListener {
            lifecycleScope.launch {
                ...
                if (isPro) {
                    ...
                    fragmentNavigator.start(com.dailybook.keep.screen.premium.PremiumSettingsFragment.newInstance())
    ...
    private fun openAppUpdatePage(context: Context) {
        val appPackageName = "com.dailybook" // Replace with your app package name
        try {
