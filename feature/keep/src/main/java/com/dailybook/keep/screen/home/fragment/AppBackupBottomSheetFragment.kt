...
import com.dailybook.keep.databinding.FragmentAppBackupBottomsheetBinding
...
class AppBackupBottomSheetFragment : BaseBottomsheetFragment<FragmentAppBackupBottomsheetBinding>() {
    ...
    private fun setupViews() {
        binding?.apply {
            ...
            tvLastUpdated.text = getString(com.dailybook.keep.R.string.last_updated, finalTime)
        }
    }
