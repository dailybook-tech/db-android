...
class AttendanceTest {
    ...
    fun testMarkPresentAttendance() {
        ...
        // Mark present
        val presentButton = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_present"))
        assertTrue("Present button not found", presentButton.exists())
        presentButton.click()
        
        // Add note if field exists
        val noteInput = device.findObject(UiSelector().resourceId("co.dailybook:id/et_note"))
        if (noteInput.exists()) {
            noteInput.setText("Test present attendance")
        }
        
        // Save attendance
        val saveButton = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_save_attendance"))
    ...
    fun testMarkAbsentAttendance() {
        ...
        // Mark absent
        val absentButton = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_absent"))
    ...
    fun testMarkHalfDayAttendance() {
        ...
        // Mark half day
        val halfDayButton = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_half_day"))
    ...
    fun testCalendarNavigation() {
        ...
        val calendarView = device.findObject(UiSelector().resourceId("co.dailybook:id/calendar_view"))
        assertTrue("Calendar view not found", calendarView.exists())
        
        // Test month navigation
        val nextMonthButton = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_next_month"))
        if (nextMonthButton.exists()) {
            nextMonthButton.click()
            // Verify month changed
            val monthText = device.findObject(UiSelector().resourceId("co.dailybook:id/tv_month_year"))
    ...
    fun testMarkOvertime() {
        ...
        // Mark overtime
        val overtimeButton = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_overtime"))
        if (overtimeButton.exists()) {
            overtimeButton.click()
            
            // Enter overtime hours
            val hoursInput = device.findObject(UiSelector().resourceId("co.dailybook:id/et_overtime_hours"))
            assertTrue("Overtime hours input not found", hoursInput.exists())
            hoursInput.setText("2")
            
            // Save overtime
            val saveButton = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_save_overtime"))
    ...
    fun testAttendanceHistory() {
        ...
        val historyButton = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_attendance_history"))
        if (historyButton.exists()) {
            ...
            val historyList = device.findObject(UiSelector().resourceId("co.dailybook:id/rv_attendance_history"))
    ...
    private fun createTestStaff() {
        ...
        if (!existingStaff.exists()) {
            ...
            // Enter staff name
            val nameInput = device.findObject(UiSelector().resourceId("co.dailybook:id/et_staff_name"))
            nameInput.setText(testStaffName)
            
            // Enter phone number
            val phoneInput = device.findObject(UiSelector().resourceId("co.dailybook:id/et_staff_phone"))
            phoneInput.setText("9876543210")
            
            // Click save
            val saveButton = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_save"))
            saveButton.click()
    ...
    private fun navigateToAddStaff() {
        ...
        if (!addStaffButton.exists()) {
            val fabButton = device.findObject(UiSelector().resourceId("co.dailybook:id/fab_add"))
            if (fabButton.exists()) {
                fabButton.click()
            } else {
    ...
    private fun performLogin() {
        ...
        // Enter phone number
        val phoneInput = device.findObject(UiSelector().resourceId("co.dailybook:id/et_number"))
        phoneInput.setText("9090909090")
        
        // Click get OTP button
        val getOtpButton = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_login"))
        getOtpButton.click()
        ...
        // Enter OTP
        val otpView = device.findObject(UiSelector().resourceId("co.dailybook:id/otp_view"))
        otpView.setText("4242")
        
        // Click verify button
        val verifyButton = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_verify_otp"))
        verifyButton.click()
