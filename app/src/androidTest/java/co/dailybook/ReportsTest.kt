...
class ReportsTest {
    ...
    fun testGeneratePDFReport() {
        ...
        // Generate PDF
        val generateButton = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_share_pdf"))
    ...
    fun testMonthSelectionInReports() {
        ...
        val monthSelector = device.findObject(UiSelector().resourceId("co.dailybook:id/btn_month_selector"))
