...
class StaffManagementTest {
    ...
    fun testEditStaff() {
        ...
        // Click edit button
        val editButton = device.findObject(UiSelector().resourceId("com.dailybook:id/btn_edit"))
        editButton.click()
    ...
    fun testStaffSearch() {
        ...
        // Find search field
        val searchField = device.findObject(UiSelector().resourceId("com.dailybook:id/et_search"))
    ...
    private fun navigateToStaffList() {
        ...
        val staffListButton = device.findObject(UiSelector().resourceId("com.dailybook:id/btn_staff_list"))
