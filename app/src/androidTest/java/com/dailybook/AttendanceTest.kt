...
class AttendanceTest {
    ...
    fun testMarkAbsentAttendance() {
        ...
        // Mark absent
        val absentButton = device.findObject(UiSelector().resourceId("com.dailybook:id/btn_absent"))
    ...
    fun testMarkHalfDayAttendance() {
        ...
        // Mark half day
        val halfDayButton = device.findObject(UiSelector().resourceId("com.dailybook:id/btn_half_day"))
    ...
    fun testCalendarNavigation() {
        ...
        val calendarView = device.findObject(UiSelector().resourceId("com.dailybook:id/calendar_view"))
        assertTrue("Calendar view not found", calendarView.exists())
        
        // Test month navigation
        val nextMonthButton = device.findObject(UiSelector().resourceId("com.dailybook:id/btn_next_month"))
    ...
    fun testMarkOvertime() {
        ...
        // Mark overtime
        val overtimeButton = device.findObject(UiSelector().resourceId("com.dailybook:id/btn_overtime"))
        if (overtimeButton.exists()) {
            overtimeButton.click()
            
            // Enter overtime hours
            val hoursInput = device.findObject(UiSelector().resourceId("com.dailybook:id/et_overtime_hours"))
            assertTrue("Overtime hours input not found", hoursInput.exists())
            hoursInput.setText("2")
            
            // Save overtime
            val saveButton = device.findObject(UiSelector().resourceId("com.dailybook:id/btn_save_overtime"))
    ...
    fun testAttendanceHistory() {
        ...
        val historyButton = device.findObject(UiSelector().resourceId("com.dailybook:id/btn_attendance_history"))
        if (historyButton.exists()) {
            ...
            val historyList = device.findObject(UiSelector().resourceId("com.dailybook:id/rv_attendance_history"))
