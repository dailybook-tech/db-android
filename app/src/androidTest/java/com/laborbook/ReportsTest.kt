...
class ReportsTest {
    ...
    fun testGeneratePDFReport() {
        ...
        // Generate PDF
        val generateButton = device.findObject(UiSelector().resourceId("com.laborbook:id/btn_share_pdf"))
    ...
    fun testMonthSelectionInReports() {
        ...
        val monthSelector = device.findObject(UiSelector().resourceId("com.laborbook:id/btn_month_selector"))
