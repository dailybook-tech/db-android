...
interface Navigator {
     ...
     */
    fun resetWithFragmentProvider(rootFragmentProvider: ArrayList<() -> Fragment>)
    ...
    fun observeDestinationChangesWithTabChange(
        lifecycleOwner: LifecycleOwner,
        destinationChangedListener: (Fragment, Boolean) -> Unit,
    )

    fun observeDestinationChangesWithPopBack(
        lifecycleOwner: LifecycleOwner,
        destinationChangedListener: (Fragment, Boolean) -> Unit
    )
}
