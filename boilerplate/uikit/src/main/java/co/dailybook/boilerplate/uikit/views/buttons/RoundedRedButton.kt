package co.dailybook.boilerplate.uikit.views.buttons

import android.content.Context
import android.content.res.ColorStateList
import android.util.AttributeSet
import androidx.core.content.ContextCompat
import co.dailybook.boilerplate.uikit.R
import co.dailybook.boilerplate.uikit.views.util.Utils

class RoundedRedButton : ActionButton {
    ...
    init {
        ...
        backgroundTintList = ColorStateList.valueOf(Utils.getThemeAttrData(context,R.attr.buttonRedColor))
        setTextColor(Utils.getThemeAttrData(context, R.attr.buttonEnabledTextColor))
        enabledBackgroundTintColor =  Utils.getThemeAttrData(context,R.attr.buttonRedColor)
